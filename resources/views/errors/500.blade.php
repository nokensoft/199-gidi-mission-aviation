...
<div class="max-w-2xl mx-auto text-center">
    ...
    {{-- Error Code --}}
    <span class="text-blue-600 font-bold text-sm uppercase tracking-widest block mb-3">Error 500</span>

    {{-- Title --}}
    <h1 class="text-4xl sm:text-5xl font-black text-slate-900 tracking-tight mb-4">Kesalahan Server</h1>

    {{-- Description --}}
    <p class="text-slate-500 text-base sm:text-lg leading-relaxed mb-10 max-w-lg mx-auto">
        Terjadi kesalahan pada server kami. Tim teknis kami sedang bekerja untuk memperbaikinya. Silakan coba lagi nanti.
    </p>
